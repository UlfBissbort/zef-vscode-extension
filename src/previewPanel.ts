/* +++
ET.TypeScriptFile('🍃-5b453bf6a24fe65b852a',
  tag_=[],
  created=Time('2026-03-05 10:54:05 +0800')
)
+++ */
            ...
            for (const ref of figRefs) {
                try {
                    ...
                    if (dataUri) {
                        ...
                        dataTexts.push(`ET.MatplotlibFigurePrinted(${ref.type}('${ref.hash}'))`);
                    }
                } catch (e: any) {
        ...
        (function() {
            ...
            document.querySelectorAll('pre').forEach(function(pre, preIndex) {
                ...
                if (isMermaid) {
                    ...
                    mermaidExpandBtn.innerHTML = '<svg viewBox="0 0 24 24"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>';
                ...
                if (isSvelte) {
                    ...
                    svelteExpandBtn.innerHTML = '<svg viewBox="0 0 24 24"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>';
                ...
                if (message.type === 'zefEntityResize') {
                    ...
                    if (resultValue) {
                        ...
                        if (result.status === 'error') {
                            ...
                            // Show matplotlib figures if any — these are rendered inside sideEffectsValue below
                            // (figures are side effects, rendered as type-specific UI elements)
                            
                            // If nothing to show
                            if (!html && !(result.figures && result.figures.length > 0)) {
