...
- **Inline LaTeX Math Rendering**: Inline math (`$...$`) containing underscores, pipes, or backslashes is no longer mangled by the markdown parser. Previously only display math (`$$...$$`) was protected.
